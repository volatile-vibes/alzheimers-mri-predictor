...
# ✅ Step 3: Load dataset (point to your new dataset folder)
dataset_path = r"C:\Users\Sai Vaibhav Vulli\Jadal\alzhimers\DATASET V2S\combined dataset\train"
...
print("Model saved as alz_model.pth")
